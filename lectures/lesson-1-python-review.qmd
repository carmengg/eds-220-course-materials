...
This is a short reveiw about some core concepts in Python exemplified by objects in the `numpy` library. The goal is to recall basic Python vocabulary that will be used throughout the course, rather than to serve as an introduction to Python programming. 
...
- Identify some of the basic differences in R and Python syntax.
...
In this lesson we will use NumPy to review some core concepts in Python you should be already familiar with. 
